...
## Section III: businesses.html:
    ...
    3. Hovering on a marker on the map shows the business name,
     and clicking on it will scroll and highlight the business entry.
    4. On each business entry on the list on the left side of the page,
     you may press 'add bookmark' to bookmark the business,
     and you may press open reviews to open the reviews for the business, moving to reviews.html
    5. On the bottom bar, you may change your username by typing in a username then pressing the 'change username' button
